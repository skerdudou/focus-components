...
var validate = require('focus-core').definition.validator.validate;
...
var validationMixin = {
    ...
    */
    ...
    _customValidate: function _customValidate(_ref) {
        ...
        var isValid = _componentValidation.isValid;
        var message = _componentValidation.message;
    ...
    */
    validate: function validate() {
        ...
        var validationStatus = shouldComponentHandleValidation ? this._customValidate(this.refs.input) : this.validateInput();
