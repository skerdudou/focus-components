...
var ArgumentInvalidException = require('focus-core').exception.ArgumentInvalidException;
...
var popin = {
    ...
    toggleOpen: function toggleOpen() {
        ...
        if (opened) {
            var popinWindow = ReactDOM.findDOMNode(this.refs['popin-window']);
            var popinOverlay = ReactDOM.findDOMNode(this.refs['popin-overlay']);
