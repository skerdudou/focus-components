...
var ComponentCard = (function (_Component) {
    ...
    ComponentCard.prototype.render = function render() {
        ...
        var style = { background: 'url(\'' + photo + '\') bottom right  no-repeat rgb(33, 150, 243)', height: '320px' };
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'h2',
                    { className: 'mdl-card__title-text', style: titleStyle },
                    name
                )
            ),
            React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'i',
                        { className: 'material-icons', style: titleStyle },
                        'share'
                    )
                )
            )
