...
describe('The input text', function () {
    ...
    describe('when a formatter is provided', function () {
        ...
        before(function () {
             ...
             */
            function formatter(value, mode) {
                isEditFormatterSpy(mode);return formatedValue;
            } // eslint-disable-line
        ...
        it('should call the isEdit formatter with the mode', function () {
    ...
    describe('when an unformatter is provided', function () {
        ...
        before(function () {
             ...
             * @return {string} - The formated value
             */
            function unformatter(value, mode) {
                unFormatterSpy(mode);return unformatedValue;
            } //eslint-disable-line
        ...
        it('should call unformatter with mode', function () {
