...
var Select = (function (_Component) {
    ...
    function Select() {
        ...
        this.getValue = function () {
            ...
            return _lodashLang.isUndefined(value) || UNSELECTED_KEY === value ? null : value;
        };
    ...
    Select.prototype._renderOptions = function _renderOptions(_ref2) {
        ...
        if (true === hasUndefined || true === isRequired && !_lodashLang.isUndefined(value) && !_lodashLang.isNull(value)) {
            ...
            values = _lodashArray.union([(_ref = {}, _ref[labelKey] = this.i18n('select.unSelected'), _ref[valueKey] = UNSELECTED_KEY, _ref)], values);
        }
        return values.map(function (val, idx) {
            var optVal = '' + val[valueKey];
            var elementValue = val[labelKey];
            var optLabel = _lodashLang.isUndefined(elementValue) || _lodashLang.isNull(elementValue) ? _this2.i18n('select.noLabel') : elementValue;
